...
- <span style="color:blue">Define </span> a concept of <span style="color:blue">"new"</span> in baseball that will be rare and inexhaustible.
...
## Some of the 304 Impossible Transitions Out of 600 Conceivable
...
- Thus, <span style="color:blue">"new"</span> half innings will <span style="color:blue">always</span> be <span style="color:blue">possible</span>.
