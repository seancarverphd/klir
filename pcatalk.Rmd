...
- 13 -- Runners on first and thrid
- 23 -- Runners of second and third
- 123 -- Bases loaded
...
The state of a baseball half-inning can be described by which bases have runners and how many outs there are.
...
```{r wordcloudhalfinnings, message=F, echo=F, fig.cap='Most common half-innings, predicted from 2011 Major League season data.  Those with predicted probabilities less than 0.01 are lumped together as "Rare".'}
set.seed(3)
require(wordcloud)
