...
```{r wordcloudstates, eval=F, message=F, echo=F, fig.cap='The 25 states of baseball, ar
ranged randomly, and sized according to frequency of appearance during 2011 Major League play.'}
