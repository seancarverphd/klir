...
- What we consider "new" should be ...
- ... a relatively <span style="color:blue">rare event</span>, and
- ... inexhaustible, so that new will <span style="color:blue">always</span> be <span style="color:blue">possible</span>.
...
## The Most Frequent States: 0 and XXX
...
The 20 remaining conceivable transitions from the 0 state (e.g. 0:XXX) are not possible (in other words illegal based on the rules of the game).

## 24 Transitions Are Possible From the 123 State (Bases Loaded, No Outs)

- All final states are possible from 123, except 123XX

## Some of the 304 Illegal Transitions Out of 600 Conceivable Ones

- 123X:123
- 0:123
- 0:0XX

## The 272 Transitions From 2011
```{r wordcloudtransitions, message=F, echo=F, fig.cap='272 transitions sized by frequency of occurrence in the 2011 Major League Season.  Additionally, there were 24 legal transitions that never occurred that season (not shown).'}
...
## Only 9 half-innings are 1% frequent
...
![Relative frequencies after 1.8 Million simulated half-innings (9 shown are more than 1% frequent) assuming 2011 transition probabilities.](InningWordCloud.png)


## When Does Something New Happen In Baseball?

- The <span style="color:blue">sequence of transitions</span> between states in a half-inning is an outcome that <span style="color:blue">might be "new"</span> in Baseball.
- With no cap on the score, there are infinitely many possible half-innings.
- Only finitely many will ever be played.
- Thus, <span style="color:red">"new"</span> half innings will <span style="color:blue">always</span> be <span style="color:blue">possible</span>.
- A "new" half inning is a relatively <span style="color:blue">"rare" event</span> in major league play (see next slide).
...
- What is the distribution of occurrences of new half-innings over seasons of major league play?  Today, what is the probability of a "new" half-inning?
- What is the least likely half-inning that has in fact been played in major league history?

## Recap of Talk

- I have <span style="color:blue">defined "new"</span> events in Baseball to be relatively rare and always possible.
- I have <span style="color:blue">asked questions</span> that I think Baseball fans would be curious to have answered.
- Finally ...

## Call to Action

- Are you interested in answering these or similar questions?
