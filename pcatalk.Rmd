...
- We want a "new" outcome to be a <span style="color:blue">rare event</span>.
- We want a "new" outcome to <span style="color:blue">always</span> be <span style="color:blue">possible</span>.

## Outline

![](pcatalkimages/pair.jpeg)

- <span style="color:blue">Define "new"</span> in baseball to be rare and always possible.
...
- Presumbably, a "new" half innings is a <span style="color:blue">rare event</span> in major league play.
...
- I have <span style="color:blue">defined "new"</span> events in Baseball to be rare and always possible.
- I have <span style="color:blue">asked questions</span> that I think Baseball fans would be curious to have answered.
- Finally ...

## Call to Action

- Are you interested in answering these questions?
