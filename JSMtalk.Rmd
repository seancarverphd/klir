...
**Question:** How similar is the model of the NY Yankees Baseball team to the model of our home team, Baltimore Orioles?
...
- The quantile.columns list the value for which 95% (or some other confidence level) of the summed likelihood ratios is above that value (i.e. the $5^{th}$ percentile).
