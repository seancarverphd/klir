...
occurred, for a large number of games.  Could you tell which teams were up
...
suffice to identify the teams with confidence?

Once you derive a model of each team from data, you can ask yourself,
for example: how similar is the model of the our home team, the
Baltimore Orioles, to the model one of their rivals, the New York
...
the simulations, getting this answer right at least 95\% of the time
